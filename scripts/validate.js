...
//     const toggleButtonAddState = (inputsAdd, buttonAdd) => {
//         if (hasInvalidAddValue(inputsAdd)) {
//             buttonAdd.classList.add(config.inputErrorAddClass);
//             buttonAdd.disabled = true;
//         }
//         else {
//             buttonAdd.classList.remove(config.inputErrorAddClass);
...
//         const buttonAdd = form.querySelector(config.submitAddButtonSelector);
...
//         toggleButtonAddState(inputsAdd, buttonAdd);
